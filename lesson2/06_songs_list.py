...
summa = round(halo + enjoy + clean, 2)
print('Три песни звучат ' + str(summa) + ' минут')
...
summa_dict = round(sweet + policy + blue, 2)
print('А другие три песни звучат ' + str(summa_dict) + ' минут')