...
secret_message = [
    'квветфпп6щ3стмзалтнмаршгб5длгуча',
...
slovo1 = secret_message[0][2] + ' '
slovo2 = secret_message[1][9:13] + ' '
slovo3 = secret_message[2][5:15:2] + ' '
slovo4 = secret_message[3][12:6:-1] + ' '
slovo5 = secret_message[4][20:15:-1]

print(slovo1 + slovo2 + slovo3 + slovo4 + slovo5)